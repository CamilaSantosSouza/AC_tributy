    ...
    <div class="px-3 py-2 bg-primary text-white">
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <a href="profile.php" type="button" class="btn btn-primary"></form><i class="bi bi-person"></i>Profile</button></a>
          <a href="main.php" type="button" class="btn btn-primary" method="POST" ><i class="bi bi-house"></i> Home</button></a>
